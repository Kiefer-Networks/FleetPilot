...
abstract final class AppColors {
  ...
  static Color neutral(Brightness brightness) => brightness == Brightness.light
  ...
  static Color iconBlue(Brightness brightness) => brightness == Brightness.light
  ...
  static Color iconRed(Brightness brightness) => brightness == Brightness.light
      ? const Color(0xFFDC2626)
      : const Color(0xFFF87171);

  static Color iconTeal(Brightness brightness) => brightness == Brightness.light
  ...
  static Color iconCyan(Brightness brightness) => brightness == Brightness.light
  ...
  static Color iconGrey(Brightness brightness) => brightness == Brightness.light
