...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Threat&&(identical(other.classification, classification) || other.classification == classification)&&(identical(other.dateOfDetection, dateOfDetection) || other.dateOfDetection == dateOfDetection)&&(identical(other.deviceId, deviceId) || other.deviceId == deviceId)&&(identical(other.deviceName, deviceName) || other.deviceName == deviceName)&&(identical(other.fileHash, fileHash) || other.fileHash == fileHash)&&(identical(other.fileName, fileName) || other.fileName == fileName)&&(identical(other.filePath, filePath) || other.filePath == filePath)&&(identical(other.processName, processName) || other.processName == processName)&&(identical(other.status, status) || other.status == status)&&(identical(other.threatId, threatId) || other.threatId == threatId)&&(identical(other.threatName, threatName) || other.threatName == threatName));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,classification,dateOfDetection,deviceId,deviceName,fileHash,fileName,filePath,processName,status,threatId,threatName);

@override
String toString() {
  return 'Threat(classification: $classification, dateOfDetection: $dateOfDetection, deviceId: $deviceId, deviceName: $deviceName, fileHash: $fileHash, fileName: $fileName, filePath: $filePath, processName: $processName, status: $status, threatId: $threatId, threatName: $threatName)';
}
...
/// Create a copy of Threat
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? classification = freezed,Object? dateOfDetection = freezed,Object? deviceId = freezed,Object? deviceName = freezed,Object? fileHash = freezed,Object? fileName = freezed,Object? filePath = freezed,Object? processName = freezed,Object? status = freezed,Object? threatId = freezed,Object? threatName = freezed,}) {
...
switch (_that) {
case _Threat() when $default != null:
return $default(_that.classification,_that.dateOfDetection,_that.deviceId,_that.deviceName,_that.fileHash,_that.fileName,_that.filePath,_that.processName,_that.status,_that.threatId,_that.threatName);case _:
  return orElse();
...
/// Create a copy of Threat
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? classification = freezed,Object? dateOfDetection = freezed,Object? deviceId = freezed,Object? deviceName = freezed,Object? fileHash = freezed,Object? fileName = freezed,Object? filePath = freezed,Object? processName = freezed,Object? status = freezed,Object? threatId = freezed,Object? threatName = freezed,}) {
